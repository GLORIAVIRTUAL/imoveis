...
export default function Cartorio24hPage() {
  ...
  return (
    <div className="form-container fade-in">
      <h1 className="text-2xl font-bold text-center text-gray-800 mb-6">Cartório 24h</h1>
      <p className="text-center text-gray-600 mb-8">Envie seu contrato assinado (PDF) para registro. O documento registrado será devolvido ao seu email cadastrado.</p>

      <div className="bg-white p-6 rounded-lg shadow-md">
        <form className="space-y-4">
          <div>
            <label htmlFor="contractFile" className="block text-sm font-medium text-gray-700 mb-2">Selecione o Contrato Assinado (PDF)</label>
              ...
              <div className="space-y-1 text-center">
                ...
                <div className="flex text-sm text-gray-600">
                  <label htmlFor="contractFile" className="relative cursor-pointer bg-white rounded-md font-medium text-primary hover:text-primary/80 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary">
                    <span>Carregar o arquivo PDF</span>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  Após clicar em "Finalizar", você será redirecionado para o pagamento da taxa de serviço. O contrato será enviado ao cartório parceiro e o documento registrado será devolvido ao seu email cadastrado após a confirmação.
                </p>
              </div>
            </div>
          </div>
